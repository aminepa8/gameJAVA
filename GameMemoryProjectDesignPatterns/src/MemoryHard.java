...
public class MemoryHard extends Memory{
    ...
    private Timer delay;
	 ...
	 public MemoryHard(){
		 super("Memory Game Hard Level");
		// this.gameBoard = GameBoardHard;
		 ...
		 // Allocate the interface elements
	        ...
	        boardView.setLayout(new GridLayout(5, 5, 10, 10));//GridLayout(int rows, int columns, int hgap, int vgap):
	        //
