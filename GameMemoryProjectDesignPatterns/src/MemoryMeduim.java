...
public class MemoryMeduim extends Memory{
    ...
    private Timer delay;
	 ...
	 public MemoryMeduim(){
		 super("Memory Game Meduim Level");
		 ...
		 // Allocate the interface elements
	        ...
	        boardView.setLayout(new GridLayout(4, 4, 10, 10));//GridLayout(int rows, int columns, int hgap, int vgap):
	        //
	...
	public void actionPerformed(ActionEvent e)   {
        ...
        if(pairsFound == 8 && wildCardFound == 0){
            gameTimer.stop();
