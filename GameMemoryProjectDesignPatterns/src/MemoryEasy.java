...
public class MemoryEasy extends Memory{
    ...
    private Timer delay;
	 ...
	 public MemoryEasy(){
		 super("Memory Game Easy Level");
		// this.gameBoard = gameBoardEasy;
		 ...
		 // Allocate the interface elements
	        ...
	        boardView.setLayout(new GridLayout(3, 3, 10, 10));//GridLayout(int rows, int columns, int hgap, int vgap):
	        //
	...
	public void actionPerformed(ActionEvent e)   {
        ...
        if(pairsFound == 4 && wildCardFound == 1){
            gameTimer.stop();
